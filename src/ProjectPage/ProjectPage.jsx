...
import ProjectCard from "./../component/MainContent/ProjectCard/ProjectCard"
...
const react = [ 
  ...
  return (
    <>
      <section className="Project-section mx-5">
        <div className="project-text my-5" style={{textAlign : "center"}}>
            <h1>Projects</h1>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus id libero reprehenderit. </p>
        </div>
